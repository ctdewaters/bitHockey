    ...
    public class Scoreboard: UIVisualEffectView {
    ...
    fileprivate class ScoreView: UIView {
        ...
        private var scoreAnimationLabel: UILabel!
        
        init(frame frameRect: CGRect, isUserTeam isOnUserTeam: Bool) {
            super.init(frame: frameRect)
        ...
        @objc private func scoreGoal() {
            ...
            UIView.animate(withDuration: 0.175, animations: {
                ...
                if completed {
                    UIView.animate(withDuration: 0.175, animations: {
                        self.scoreLabel.text = "\(currentScore + 1)"
